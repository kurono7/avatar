...
import { headerHeight, disconnectPage, disconnectRoute, landingBackgroundImage, landingBackgroundColor } from '../config';
    ...
    <div className={className}>
      <div className="video-overlay" ref={overlayRef} style={{ height }}>
        ...
        <div className="container d-flex flex-column">
          <div />
          {/* middle row */}
          <div className="vertical-fit-container col-xl-8"  style={{background:"transparent",height:"70vh",marginTop: "12rem"}}>
