...
import TodosCasos from './ContentCards/TodosCasos';
import TermsAndConditions from './ContentCards/TermsAndConditions';
import Rangofecha from './ContentCards/Rangofecha';
import Respuesta from './ContentCards/Respuesta';
import Redes from './ContentCards/Redes';
import GenericCard from './ContentCards/GenericCard';
import Zona from './ContentCards/Zona';
import Twitter from './ContentCards/twitter';
import Periodico from './ContentCards/Periodico';
import Indiciado from './ContentCards/Indiciado';
